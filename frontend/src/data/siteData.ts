...
export const LAW_FALLBACK = u('1589829545856-d10d557cf95f', 1400)

export const LAW_IMG = {
...
export const CASES: CaseStudy[] = [
  {
    ...
    video: LAW_VID.gavelHands,
    poster: LAW_IMG.judgeGavel,
    aspect: 'landscape',
  },
  {
    id: 'sterling',
    ...
    video: LAW_VID.signing,
    poster: LAW_IMG.signingDocs,
    aspect: 'square',
  },
  {
    id: 'atlas',
    ...
    video: LAW_VID.reading,
    poster: LAW_IMG.lawBooks,
    aspect: 'landscape',
  },
  {
    id: 'northgate',
    ...
    video: LAW_VID.meeting,
    poster: LAW_IMG.contractHandshake,
    aspect: 'square',
  },
]
...
export const INSIGHTS = [
  ...
  },
  {
    ...
    minutes: '6 min read',
    image: LAW_IMG.courthouseColumns,
  },
  {
    tag: 'Briefing',
    date: 'Feb 2026',
...
export function previewImageFor(code: string): string {
  const map: Record<string, string> = {
    '01': LAW_IMG.judgeGavel,
    '02': LAW_IMG.contractHandshake,
    '03': LAW_IMG.lawBooks,
    '04': LAW_IMG.signingDocs,
    '05': LAW_IMG.lawLibrary,
    '06': LAW_IMG.courtBuilding,
  }
  return map[code] ?? LAW_FALLBACK
}
