...
// ============ Case Studies ============
function Cases() {
  const [activeId, setActiveId] = useState(window.CASES[0].id);
  const active = window.CASES.find((c) => c.id === activeId);
  return (
...
Object.assign(window, { Cases, Methodology, Testimonials, Stat });
